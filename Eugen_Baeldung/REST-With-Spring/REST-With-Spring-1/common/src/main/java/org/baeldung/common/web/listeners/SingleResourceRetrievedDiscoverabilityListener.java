...
@Component
class SingleResourceRetrievedDiscoverabilityListener implements 
                    ApplicationListener<SingleResourceRetrievedEvent> {
    ...
    final void discoverGetAllURI(final UriComponentsBuilder uriBuilder, 
